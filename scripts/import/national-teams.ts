...
export const NATIONAL_TEAMS: Record<string, { en: string; nb: string; aliases?: string[] }> = {
  ...
  BAH: { en: "Bahrain", nb: "Bahrain" },
  BEL: { en: "Belgium", nb: "Belgia" },
  BER: { en: "Bermuda", nb: "Bermuda" },
  ...
  CSK: { en: "Czechoslovakia", nb: "Tsjekkoslovakia" },
  ...
  TRI: { en: "Trinidad and Tobago", nb: "Trinidad og Tobago", aliases: ["Trinidad & Tobago"] },
  UAE: { en: "United Arab Emirates", nb: "De forente arabiske emirater", aliases: ["United Arab Emirates (the)", "Forente Arabiske Emirater"] },
  UKR: { en: "Ukraine", nb: "Ukraina" },
  URU: { en: "Uruguay", nb: "Uruguay" },
  URS: { en: "Soviet Union", nb: "Sovjetunionen" },
  USA: { en: "United States", nb: "USA", aliases: ["United States of America"] },
  WAL: { en: "Wales", nb: "Wales" },
  ZAM: { en: "Zambia", nb: "Zambia" },
