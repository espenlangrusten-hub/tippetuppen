...
export const metadata: Metadata = { title: "Finn spilleren", description: "Finn den norske landslagsspilleren med opptil fem hint.", alternates: { canonical: "/finn-spilleren" } };
